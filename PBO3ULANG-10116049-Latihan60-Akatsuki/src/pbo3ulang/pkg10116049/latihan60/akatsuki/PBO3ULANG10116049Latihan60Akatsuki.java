 ...
 * DESKRIPSI PROGRAM :
 */
public class PBO3ULANG10116049Latihan60Akatsuki {
    ...
    public static void main(String[] args) {
        ...
        ck2.tampilAkatsuki();
        JurusAndalan j2 = new JurusAndalan();
